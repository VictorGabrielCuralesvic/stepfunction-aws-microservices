# stepfunction-aws-microservices
...
- Lambda Console -> Create function -> Author from scratch -> Function name [rekognition-api-function] -> Runtime [Python3.10] -> Role [Create new role with basic Lambda permissions] -> Create function
